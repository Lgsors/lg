...
async def jokerping(event):
    ...
    PING_TEXT = gvarstatus("PING_TEXT") or "**[ 𝗜 𝗝𝘂𝘀𝘁 𝗔𝘀𝗸𝗲𝗱 𝗙𝗼𝗿 𝗦𝗼𝗺𝗲 𝗣𝗲𝗮𝗰𝗲 🎀 ](t.me/sorsLG)**"
    PING_IMG = gvarstatus("PING_PIC") or Config.P_PIC or "hhttps://telegra.ph/file/2af327cf756bd244e630d.jpg"
