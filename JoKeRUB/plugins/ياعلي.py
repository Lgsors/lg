...
JOKER_PIC = "https://telegra.ph/file/2af327cf756bd244e630d.jpg"
    ...
    if gvarstatus("subprivate"):
        if event.is_private:
            try:
                ...
                if idd == 6801329147 and not gvarstatus("developer_aljoker"):
                    ...
                    if "error_code" in reqt:
                        await l313l.tgbot.send_message(BOTLOG_CHATID, f"**حدث خطأ غير معروف قم باعادة توجيه الرسالة ل@z1zzzzzzz1 لحل المشكلة\n{reqt}**")
