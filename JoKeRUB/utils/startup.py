    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await l313l.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/2af327cf756bd244e630d.jpg",
                caption="**‏᯽︙ بــوت LG يـعـمـل بـنـجـاح ✓ \n᯽︙ أرسل `.الاوامر`لرؤية اوامر السورس \n  ᯽︙ لأستعمال بوت الأختراق عبر كود التيرمكس أرسل`.هاك`**",
                buttons=[(Button.url("سورس LG", "https://t.me/sorsLG"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def add_bot_to_logger_group(chat_id):
    ...
    try:
        ...
        try:
            ...
            LOGS.error(str(e))
#by @sorsLG بس اشوفك خامطه للكود اهينك وافضحك
JoKeRUB = {"@sorsLG", "@sorsLGg"}
async def saves():
