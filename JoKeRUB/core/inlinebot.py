...
ROZLOGO = "https://telegra.ph/file/30f0de152c059ad5f7b35.jpg"
...
def main_menu():
    text = f"**- [سـورس LG](https://t.me/sorsLG)\
        \n المسـاعد\
        \n\
        \n◽ LG لـ {mention}**"
    buttons = [
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("l313l"):
            buttons = [
                (
                    ...
                    Button.url(" JoKeRUB UsᴇʀBoᴛ", "https://t.me/sorsLG"),
                )
            ]
            ...
            result = builder.article(
                title="رسـالة تـرول من سـورس LG 🧸♥",
            ...
            result = builder.article(
                title="رسـالة مخفيـة من سـورس LG 🧸♥",
                text=f"✖✖✖",
                buttons=buttons,
            )
            await event.answer([result] if result else None)
        ...
        buttons = [
            (
                Button.url("قنـاة السـورس ⚒️", "https://t.me/sorsLG"),
                Button.url(
                    "كـروب المـساعدة 📬",
                    "https://t.me/sorsLG1",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "**[بـوت LG 🧸♥](https://t.me/sorsLG)**\
            \n\
            \n❤ LG هـو بـوت بسـيط يدخـل الـى حسـابك لجعـلك تتحـكم به معـ اوامـر معينـة.\
            \n\
            \n**اذا كـنت تـرغب بتـنصيـب السـورس عـلى حسـابك ,\
            \n🐾 تعال الـى [كروب المسـاعدة](https://t.me/sorsLG1)!**",
            "md",
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
