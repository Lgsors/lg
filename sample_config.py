...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Lgsors/lg.git"
    )
    ...
    PMPERMIT_TEXT_jhad = os.environ.get("PMPERMIT_TEXT_jhad", None)
    UB_BLACK_LIST_CHAT = {
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/2af327cf756bd244e630d.jpg"
    )
    # specify NO_LOAD with plugin names for not loading in jhad
